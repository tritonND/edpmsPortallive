        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-4 col-sm-6 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Outstanding Depts </span>
              ...
              <div class="dashboard_graph">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 bg-white">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-6">
                    <div>
                      <p>Dualization of Benin/Auchi rd</p>
                      <div class="">
                    ...
                    <div>
                      <p>Akoko-Edo Schools libraries</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-6">
                    <div>
                      <p>ICTA Biometrics & Verification</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
