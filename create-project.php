...
if(isset($_SESSION['privileges']))
{
    ...
    if((strpos($priv,"createproject")!==FALSE)||(strpos($priv,"sysadmin")!==FALSE))//check if he has dashboard privilege
    {
        ...
        // echo "<script>alert('You are not permitted here');location.href='create-project.php';</script>";
    }
}
else{
