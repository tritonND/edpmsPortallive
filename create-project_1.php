...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="budgethead" required
    data-required-error="budget head is required">
    <div class="help-block with-errors"></div>
    </div>

    <div class="form-group">
    <label for="budgetsubhead">Budget Sub-head:</label>
    <input type="text" class="form-control" id="budgetsubhead" required
    data-required-error="budget sub-head is required">
    <div class="help-block with-errors"></div>
    </div>

    <div class="form-group">
    <label for="budgetcomment">Budget Comment:</label>
    <input type="text" class="form-control" id="budgetcomment" required
    data-required-error="budget comment is required">
    <div class="help-block with-errors"></div>
    </div>
            </div>
          ...
          <!--Start step 2 here  -->
                ...
                <div class="col-sm-3">
                    ...
                    <div class="form-group">
    <label for="approvedappropriation">Approved Appropriation(&#8358;):</label>
    <input type="text" class="form-control currency-input" id="approvedappropriation" name="approvedappropriation" required
    onblur="formatCurrency(this)"
    data-required-error="approved aprropriation is required">
    <div class="help-block with-errors"></div>
    </div>
                <div class="form-group">
    <label for="supplementaryprovision">Supplementary Provision &#8358;:</label>
    <input type="text" class="form-control" id="supplementaryprovision" name="supplementaryprovision" required
    onblur="formatCurrency(this)"
        data-required-error="supplementary provision is required">
        <div class="help-block with-errors"></div>
    </div>
                </div>
                    <div class="col-sm-6">
                    <div class="form-group">
    <label for="subsectorallocation">Sub-sector Allocation (&#8358;):</label>
    <input type="text" class="form-control" id="subsectorallocation" name="subsectorallocation" required
     onblur="formatCurrency(this)"
     data-required-error="sub-sector allocation is required">
     <div class="help-block with-errors"></div>
    </div>

     <div class="form-group">
    <label for="percentagesubsectorallocation">% of Sub-sector Allocation:</label>
    <input type="text" class="form-control" id="percentagesubsectorallocation" name="percentagesubsectorallocation" required
      ...
      data-required-error="sub-sector allocation is required">
       ...
       <div class="col-sm-3">
                    <div class="form-group">
                        <label for="approvedappropriationyear"></label>
<select id="approvedappropriationyear" name="approvedappropriationyear" class="form-control datalist" required
    data-required-error="approved appropriation year is required">
    ...
    <!--<span ><option value="Check">Check</span></option>-->                          
          ...
          <div class="help-block with-errors"></div>
                ...
                <div class="form-group">
                    <label for="supplementaryprovisionyear"></label>
                    <select id="supplementaryprovisionyear" name="supplementaryprovisionyear" class="form-control datalist" required
    data-required-error="supplementary provision year is required">
...
<textarea id="projectdescription" name="projectdescription" style="width:100%;" required
  ...
  data-required-error="Project Status is required" >
    ...
    data-required-error="project remark is required">
    <div class="help-block with-errors"></div>
    </div>
...
<textarea id="projectlocation" name="projectlocation" style="width:100%;" required
 ...
 <div class="form-group">
    ...
    <select id="durationmonths"  style="height:20px;" name="durationmonths" >
...
<select id="consultant" name="consultant" class="form-control"
    ...
    data-required-error="contract sum is required">
               ...
               <div class="form-group">
    <label for="mobilisation">Mobilization(&#8358;):</label>
    <input type="text" class="form-control" id="mobilisation" name="mobilisation" required
           onblur="formatCurrency(this)"
           data-required-error="agreed mobilization is required">
           <div class="help-block with-errors"></div>
    </div>             
    ...
    <div class="form-group">
    <label for="mobilisationpaid">Mobilization Paid(&#8358;):</label>
