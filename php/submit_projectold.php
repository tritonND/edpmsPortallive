...
$mobilisation=  mysqli_real_escape_string($con,$_POST['mobilisation']);
...
else 
{
    ...
    mysqli_query($con, "insert into projectdetails(PROJECTID,PROCURINGENTITY,TITLE,DESCRIPTION,STATUS,REMARKS,LOCATION,LGA,DATEOFAWARD,DURATIONOFCONTRACT,EXPECTEDCOMPLETIONDATE,CONTRACTSUM,AGREEDMOBILIZATION,CONTRACTOR,CONSULTANT,SECTOR,SUBSECTOR) "
            . "values ('$projectid','$mda','$projecttitle','$projectdescription','$projectstatus','$remarks','$projectlocation','$lga','$dateofaward','$durationofcontract','$expecteddateofcompletion','$contractsum','$mobilisation','$contractor','$consultant','$sector','$subsector')");
